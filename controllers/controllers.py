...
class VRWebsite(http.Controller):
    ...
    @http.route('/vr/saleroom', website=True, auth='public')
...
<html>
  ...
  <body>
    ...
    <script type="module">
      ...
      import {WebXRButton} from '/odooxr-base/static/src/js/util/webxr-button.js';
      import {Scene} from '/odooxr-base/static/src/js/render/scenes/scene.js';
      import {Renderer, createWebGLContext} from '/odooxr-base/static/src/js/render/core/renderer.js';
      ...
      import {mat4, vec3, quat} from '/odooxr-base/static/src/js/render/math/gl-matrix.js';
      import {QueryArgs} from '/odooxr-base/static/src/js/util/query-args.js';

      // If requested, use the polyfill to provide support for mobile devices
      // and devices which only support WebVR.
      import WebXRPolyfill from '/odooxr-base/static/src/js/third-party/webxr-polyfill/build/webxr-polyfill.module.js';
